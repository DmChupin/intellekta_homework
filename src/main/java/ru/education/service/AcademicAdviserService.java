...
@Service
public class AcademicAdviserService {

    private final AcademicAdviserRepository academicAdviserRepository;

    private final StudentRepository studentRepository;

    public AcademicAdviserService(AcademicAdviserRepository academicAdviserRepository, StudentRepository studentRepository) {
